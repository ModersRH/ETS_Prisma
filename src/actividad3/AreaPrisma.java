...
/**
 * Clase que genera objetos Prismas y los ordena de mayor a menor area
 * 
 * @author Modesto
 *
 */
public class AreaPrisma {
	...
	/**
	 * @param args Main AreaPrisma, genera numeroPrismas de objetos Prismas con
	 *             valores aleatorios y calcula su area, y finalmente devuelve una
